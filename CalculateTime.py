...
hrsAsMins = (start_hour * 60) + start_minute
new_Length = length + hrsAsMins

lengthAshrs = new_Length // 60
lengthAsMins = new_Length % 60
print(str(lengthAshrs) + ":" + str(lengthAsMins))
