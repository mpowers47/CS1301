#There are several ways to do this next problem, but you'll probably find it easiest if you note that Python lets you multiply by booleans. 
#It treats False as 0, and True as 1. So...
