...
if (egg and milk and butter and flour) is True:
    print("pancakes")
elif (egg and milk and butter) is True and (flour) is False:
    print("omelette")
elif (egg and milk) is True and (butter and flour) is False:
    print("custard")
elif (egg) is True and (butter and flour and milk) is False:
    print("poached eggs")
else:
